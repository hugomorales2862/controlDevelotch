                            ...
                            <tr class="hover:bg-[#1e293b]/20 transition-colors group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end gap-3">
                                        @can('editar dominios')
                                        <a href="{{ route('domains.edit', $domain) }}" class="text-slate-400 hover:text-[#00f6ff] transition-colors" title="Editar">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                        </a>
                                        @endcan
                                        @can('eliminar dominios')
                                        <form action="{{ route('domains.destroy', $domain) }}" method="POST" class="inline-block delete-form">
                                            @csrf
                                            @method('DELETE')
