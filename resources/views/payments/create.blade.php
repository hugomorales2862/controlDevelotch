                ...
                <form method="POST" action="{{ route('payments.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input id="amount" class="block mt-1 w-full bg-[#0B1120] border border-[#1e293b] focus:border-[#00f6ff] focus:ring focus:ring-[#00f6ff]/20 rounded-xl text-white shadow-sm placeholder-slate-600 py-3 px-4" type="number" step="0.01" name="amount" value="{{ old('amount') }}" required />
                        ...
                        <div>
                            ...
                            <input id="paid_at" class="block mt-1 w-full bg-[#0B1120] border border-[#1e293b] focus:border-[#00f6ff] focus:ring focus:ring-[#00f6ff]/20 rounded-xl text-white shadow-sm placeholder-slate-600 py-3 px-4" type="date" name="paid_at" value="{{ old('paid_at', date('Y-m-d')) }}" required />
                        ...
                        <div>
                            ...
                            <input id="reference" class="block mt-1 w-full bg-[#0B1120] border border-[#1e293b] focus:border-[#00f6ff] focus:ring focus:ring-[#00f6ff]/20 rounded-xl text-white shadow-sm placeholder-slate-600 py-3 px-4" type="text" name="reference" value="{{ old('reference') }}" />
                    ...
                    <div class="flex items-center justify-end pt-6 border-t border-[#1e293b]">
                        <a href="{{ route('payments.index') }}" class="mr-4 text-sm font-medium text-slate-400 hover:text-white transition-colors">Cancelar</a>
