<x-guest-layout>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#0B1120] relative overflow-hidden">
        ...
        <div class="relative z-10 sm:max-w-md w-full px-8 py-10 bg-[#0f172a]/90 backdrop-blur-xl shadow-[0_0_40px_rgba(0,246,255,0.1)] border border-[#1e293b] sm:rounded-3xl">
            ...
            <div class="mb-4 text-sm text-slate-300 text-center">
                Ingresa el correo asociado a tu cuenta para recibir el enlace de reestablecimiento de contraseña.
            </div>
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                ...
                <div class="text-center pt-6">
                    <a href="{{ route('login') }}" class="text-xs font-semibold text-[#00f6ff] hover:text-white transition-colors">Volver al inicio de sesión</a>
                </div>
            </form>
        </div>
